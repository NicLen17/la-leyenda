        ...
        <div className="flex w-full flex-col items-center gap-2">
          <div className="animate-hero-brand text-center">
            <BrandLogo
              ...
              size={112}
              priority
              className="mx-auto max-sm:size-20! sm:size-24! md:size-28! shadow-[0_0_0_1px_rgba(232,163,23,0.14),0_0_24px_rgba(232,163,23,0.36),0_12px_40px_rgba(0,0,0,0.55)]"
            />
