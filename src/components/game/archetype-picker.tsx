...
export function ArchetypePicker({
  ...
  return (
    <section
      className={cn(
        "flex h-full min-h-0 flex-col items-center justify-center gap-4 px-4",
        className,
      )}
    >
      ...
      <div className="grid w-full max-w-4xl gap-3 sm:grid-cols-3">
        {options.map((archetype, index) => (
          <button
            ...
            className="animate-card-in group flex flex-col gap-2 rounded-xl border border-border/70 bg-card/70 p-4 text-left transition-all hover:-translate-y-1 hover:border-primary hover:bg-card focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
